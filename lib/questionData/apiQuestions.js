const apiQuestions = [{
  ...
  category: 'tech',
  tags: ['API', 'Frontend'],
  links: ['https://technologyadvice.com/blog/information-technology/how-to-use-an-api/', 'https://www.youtube.com/watch?v=3nwcNLM3KOU']
}, {
  ...
  category: 'tech',
  tags: ['API', 'Frontend'],
  links: ['https://www.youtube.com/watch?v=wJa5CTIFj7U', 'https://filecatalyst.com/rest-why-http-status-codes-are-important/']
}, {
  ...
  category: 'tech',
  tags: ['API', 'Backend'],
  links: ['https://stackoverflow.blog/2020/03/02/best-practices-for-rest-api-design/', 'https://www.youtube.com/watch?v=ER32ax96skk']
}, {
  ...
  links: ['https://www.codecademy.com/articles/what-is-rest', 'https://www.youtube.com/watch?v=6sUbt-Qp6Pg']
}, {
  ...
  category: 'tech',
  tags: ['API', 'Frontend', 'Backend', 'JavaScript', 'Node', 'React'],
  links: ['https://www.youtube.com/watch?v=JuFdz8f-cT4', 'https://www.youtube.com/watch?v=iiADhChRriM', 'https://www.w3schools.com/whatis/whatis_json.asp']
}, {
  question: 'API Question here?',
  answer: 'Answer Here.',
  hint: 'Hint Here',
  category: 'tech',
  tags: [''],
