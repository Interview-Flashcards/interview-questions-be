const cssQuestions = [
  {
    ...
    category: 'tech',
    tags: ['CSS', 'Frontend'],
    links: ['https://developer.mozilla.org/en-US/docs/Web/CSS/Specificity']
  },
  {
  ...
  },
  {
    ...
    category: 'tech',
    tags: ['CSS', 'Frontend'],
    links: ['https://www.lifewire.com/comma-in-css-selectors-3467052'] 
  },
  {
  ...
  },
  {
    ...
    category: 'tech',
    tags: ['CSS', 'Frontend'],
    links: ['https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Selectors'] 
  },
  {
    ...
    category: 'tech',
    tags: ['CSS', 'Frontend'],
    links: ['https://developer.mozilla.org/en-US/docs/Web/CSS/Pseudo-classes'] 
  }
];
